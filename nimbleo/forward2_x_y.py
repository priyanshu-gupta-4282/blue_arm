...
try:
    ...
    # Step 2: Get angles for home and drop positions
    ...
    set_servo_angle_slow(servo_pins[0], home_position[1], drop_position[1])  # Shoulder
    set_servo_angle_slow(servo_pins[1], home_position[2], drop_position[2])  # Elbow
    set_servo_angle_slow(servo_pins[2], home_position[3], drop_position[3])  # Wrist
    time.sleep(4)
